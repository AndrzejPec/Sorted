...
local function resolveManagerKey()
    if Sorted.ModOptions and Sorted.ModOptions.getManagerKeyCode then
        return Sorted.ModOptions:getManagerKeyCode()
    end
...
local function onKeyPressed(key)
    local target = resolveManagerKey()
    if key ~= target then
        return
    end
